...
public class RankingController {
    ...
    public RankingController(ResultadoService resultadoService, CorridaService corridaService) {
    ...
    public String rankingPorCorrida(@PathVariable Long corridaId, HttpSession session, Model model) {
        Participante participante = (Participante) session.getAttribute("participante");
